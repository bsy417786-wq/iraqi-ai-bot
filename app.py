...
design = """
    ...
    /* تثبيت قسم الصور بالأسفل (الصور اللي انمسحت رجعت) */
    .fixed-footer-box {
        position: fixed;
        bottom: 0;
        left: 0;
    ...
    /* مسافة أمان للمحادثة حتى لا تختفي وراء الصور الثابتة */
...
# 4. عرض المحادثة بالترتيب الطبيعي (أنت ثم عباس)
...
# 6. قسم الصور الثابتة (الرجوع القوي)
footer_html = """
